...
model_path = "/path/to/Valley3-8B-Think-0401"
...
text_only_message = [{"role": "system", "content": THINKING_SYSTEM_PROMPT}, {"role": "user", "content": [{"type": "text", "text": "Please tell me which number is larger: 3.11 or 3.8?"}],}]
image_text_message = [{"role": "system", "content": THINKING_SYSTEM_PROMPT}, {"role": "user", "content": [{"type": "image", "image": example_image_path}, {"type": "text", "text": "Describe the content."}],}]
audio_text_message = [{"role": "system", "content": THINKING_SYSTEM_PROMPT}, {"role": "user", "content": [{"type": "audio", "audio": example_audio_path}, {"type": "text", "text": "Fully transcribe the content of the audio."}],}]
video_text_message = [{"role": "system", "content": THINKING_SYSTEM_PROMPT}, {"role": "user", "content": [{"type": "video", "video": example_video_path}, {"type": "text", "text": "Describe the video in brief."}],}]
video_audio_text_message = [{"role": "system", "content": THINKING_SYSTEM_PROMPT}, {"role": "user", "content": [{"type": "video", "video": example_video_audio_path}, {"type": "text", "text": "Please describe the video in brief and transcribe what the person in the video is saying."}],}]
