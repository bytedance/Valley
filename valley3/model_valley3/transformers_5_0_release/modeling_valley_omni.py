...
class ValleyOmniModel(ValleyOmniPreTrainedModel):
    ...
    def get_image_features(self, pixel_values: torch.FloatTensor, image_grid_thw: Optional[torch.LongTensor] = None):
        ...
        # In transformers v5.0-release, `Qwen3VLVisionModel` returns a `BaseModelOutputWithDeepstackFeatures`
        # (or a tuple-like view of it). We request a dict output explicitly to keep the unpacking stable.
...
__all__ = [
    "ValleyOmniCausalLMOutputWithPast",
    "ValleyOmniForConditionalGeneration",
    "ValleyOmniModel",
    "ValleyOmniModelOutputWithPast",
    "ValleyOmniPreTrainedModel",
]
